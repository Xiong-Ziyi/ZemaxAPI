...
class PythonZOSConnection(object):
    ...
    def __init__(self):
        ...
        if self.TheApplication is None:
            raise PythonZOSConnection.Exception("Unable to acquire ZOSAPI application")
        ...
        if self.TheSystem is None:
            raise PythonZOSConnection.Exception("Unable to acquire Primary system")
...
if __name__ == '__main__':
    ...
    # ! [e04s01_py]
    # Open file
    testFile = sampleDir + 'D:\ZEMAX\off_axis_three_mirror.zmx'
