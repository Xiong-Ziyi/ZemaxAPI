...
pczl = PCZL(f_3 = 1.2, m_4 = 3, d_12s = 0.5, d_34s = 0.5, q = 0.2785, num_samples=101)
...
MC_Operand[1].GetOperandCell(1).DoubleValue = 5.0  # Thickness of Surface 2
MC_Operand[2].GetOperandCell(1).DoubleValue = 10.0 # Thickness of Surface 3
MC_Operand[3].GetOperandCell(1).DoubleValue = 0.5  # Thickness of Surface 4

# Thickness values for long focal length position
MC_Operand[1].GetOperandCell(2).DoubleValue = 5.0  # Thickness of Surface 2
MC_Operand[2].GetOperandCell(2).DoubleValue = 50.0 # Thickness of Surface 3
MC_Operand[3].GetOperandCell(2).DoubleValue = 2.0  # Thickness of Surface 4
